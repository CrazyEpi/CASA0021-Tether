...
Mobile technologies are increasingly embedded in everyday mobility practices such as walking and cycling, enabling large-scale activity tracking and social sharing through applications such as Strava. However, these systems rely on interaction models that assume sustained visual and manual attention, which is often unrealistic in real-world mobility contexts. Users must simultaneously manage movement, environmental awareness, and system interaction, creating constraints on perception and cognition that can introduce safety risks and reduce the suitability of attention-heavy interfaces during motion.

Despite their widespread use, existing solutions remain limited in supporting safe, low-attention interaction. They prioritise screen-based engagement that can distract users from their surroundings, revealing a mismatch between system design and the realities of mobile use. Beyond usability and safety, current cycling interfaces also fail to integrate awareness, motivation, safety, and social connection within a unified riding experience. While smartphones enable rich functionality, they are not well suited as primary interfaces during cycling due to their demand for continuous visual attention. Additionally, many systems focus on navigation and performance tracking, often overlooking social and emotional dimensions such as reassurance and lightweight connection.

This project is situated within Connected Environments research, which examines how computational systems are embedded into everyday contexts to connect people, devices, and environments through real-time interaction. Building on ubiquitous computing principles (Weiser, 1991), this field increasingly explores how systems can reduce attention demands and integrate more seamlessly into daily activity. However, much existing work remains smartphone-centric, limiting its effectiveness in motion-based contexts.
