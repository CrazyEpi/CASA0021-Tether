...
#ifndef GPP_FITNESS_TRACKER_SWIFT_H
#define GPP_FITNESS_TRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="gpp_fitness_tracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19gpp_fitness_tracker11AppDelegate")
...
SWIFT_CLASS("_TtC19gpp_fitness_tracker17MainFlutterWindow")
